/* =====================================================================
   ...
   - i18n hydration from translations.js (text + attributes + HTML keys)
   - nav: scrolled state + mobile menu
   - scroll reveals (IntersectionObserver, GPU-friendly)
   - hero status: typewriter / decrypt on load
   - subtle parallax on the universe panel
...
(function () {
  ...
  /* --------------------------- i18n ---------------------------------
     ...
     Keys ending in ".html" are injected as innerHTML (trusted dict).
     data-i18n-attr="content|placeholder|..." targets an attribute.    */
  ...
  // Expose for future locale switching, if a UI ever wants it.
  window.__bitoSetLang = applyI18n;
})();
