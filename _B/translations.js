...
const TRANSLATIONS = {
  en: {
    ...
    "studio.p1.html": "BITO Games is a <strong>one-person studio</strong> on the Côte d'Azur. I'm Sándor Bitó. I spent the first chapter of my life as a <strong>ballet dancer</strong> — years of turning relentless discipline into something that looks effortless. I build games the same way.",
    "studio.p2.html": "Now I'm an <strong>AI-native indie developer</strong>: I pair decades of obsession with city-builders and economic sims with modern AI tooling to ship at a scale that used to need a team. The NOVA Universe is what comes out the other side.",
